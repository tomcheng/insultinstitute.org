(function () {
  ...
  var BUCKETS = {
    insults: [
      "Get [disease] and die[you_blank][period]",
      "I [hope] [bad_thing_happens_to_you][you_blank][period]",
      "I [hope] [bad_thing_happens_to_you_2][you_blank][period]",
      "go [fuck] [yourself][you_blank][period]",
      "[you_smell] like [animal] [excrement][period]",
      "[you_are] one [adj] [noun][period]",
      "go [eat] your [relative]'s [anat][you_blank][period]",
      "go [guzzle] your [relative]'s [fluid][you_blank][period]",
      "go choke on (s)[animal]'s [penis][you_blank][period]",
      "you are (s)[adj] [noun]. You are also (s)[adj] [noun].",
      "you are (s)[adj] [noun]",
      "go [fuck] (s)[adj_animal][you_blank][period]",
      "congratulations! (c)[you_are] (s)[noun]!",
      "did you remember to feed the [pack] of (p)[animal] living in your [orifice]?",
      "you like to [stick] (p)[small_object] up your [orifice].",
      "your [relative] is (s)[noun] and [you_are] (s)[noun][period]",
      "I [hope] you get [hit] in your [slur] [sex_anat][period]",
      "a thousand (p)[sex_anat] upon [your_face][period]",
    ...
    stick: ["stick", "shove"],
    hope: ["hope","hope to god","sincerely hope","pray to god","await the day"],
    yourself: ["yourself","your [relative]"],
    relative: ["brother","child","sister","father","mother","grandfather","grandmother"],
    disease: ["AIDS","[cancer]","cholera","ebola","smallpox","leprosy"],
    cancer: ["cancer","[cancer_type] cancer"],
    cancer_type: ["cervical","colon","lung","ovarian","pancreatic","testicular"],
    adj: [
      "[compound_adj]",
      "[single_word_adj]",
    ...
    retard: ["retard","buffoon","moron","nincompoop","idiot","loser"],
    ...
    vagina: ["cunt","twat","vagina"],
    penis: ["cock","dick","penis","prick"],
	  slur: ["racist"],
    animal: ["[slur]","alligator","ape","baboon","bear","camel","chicken","chimpanzee","chihuahua","cow","crocodile","dog","donkey","elephant","goat","hippo","horse","hyena","llama","monkey","pig","rat","skunk","warthog"],
    adj_animal: ["[animal]","AIDS-infected [animal]","rabid [animal]"],
    fuck: ["bugger","fist","fondle","fuck","hump","molest","rape","slap","stroke","violate"],
    ...
    urine: ["piss","urine"],
    vomit: ["puke","vomit"],
    pube: ["pube","pubic hair","cunt hair"],
    raped: ["eaten","gang-banged","fucked","humped","molested","raped","violated"],
    ...
    worthless_thing: ["papercut","burnt-out lightbulb","toe-nail clipping","[animal]'s [excrement]","canker sore","used condom","shit-stained rock"]
  };
